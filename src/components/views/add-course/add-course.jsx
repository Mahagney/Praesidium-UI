...
function AddCourse({ history, addCourseAction }) {
    ...
    <Container component="div" maxWidth="lg" className={classes.bigContainer}>
      ...
      <Container component="div" maxWidth="lg" className={classes.flexRowContainer}>
        <Container component="div" maxWidth="sm" className={classes.smallContainer}>
          ...
          />
          <FormControl required error={!!errors.type} className={classes.formControl}>
        ...
        <Container component="div" maxWidth="sm" className={classes.smallContainer}>
          <div className={classes.dropZone} style={errors['pdfCourse'] ? { borderBottom: '3px solid red' } : {}}>
            <DropzoneArea
              onChange={(value) => handleChange({ value, name: 'pdfCourse' })}
...
AddCourse.propTypes = {
  addCourseAction: PropTypes.func.isRequired,
