    ...
    <Container component="div" maxWidth="lg" className={classes.bigContainer}>
      ...
      <Container component="div" maxWidth="sm" className={classes.smallContainer}>
        <FormControl className={classes.formControl}>
          ...
          <Select labelId="select-year" id="select-year" value={year} onChange={handleChange}>
        ...
        <FormControl className={classes.formControl}>
          ...
          <Select labelId="select-trimester" id="select-trimester" value={trimester} onChange={changeTrimester}>
